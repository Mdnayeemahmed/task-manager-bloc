...
//-----------------------Heavy 600----------------------//
  ...
  static TextStyle heavy10 = const TextStyle(
    fontSize: 10,
...
//-----------------------Huge 700----------------------//
  static TextStyle huge16 = const TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w700,
  );

  static TextStyle huge20 = const TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.w700,
  );
  static TextStyle huge24 = const TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.w700,
  );
}